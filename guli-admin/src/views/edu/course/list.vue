<template>
  <div class="app-container">
    ...
    <!-- 分页 -->
    <el-pagination :total="total" :current-page="page" :page-size="limit" style="padding: 30px 0; text-align: center;" layout="total, prev, pager, next, jumper" @current-change="fetchData" />
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    removeCourseById(id) {
      this.$confirm('此操作将永久删除该课程和简介，以及该课程下的章节和视频，是否继续?', '提示', {
